...
$(function () {
    var v_navHtml = "<nav class=\"navbar navbar-inverse\">\n" +
        ...
        "                <li id=\"loginInfo\"><a href=\"/static/login.htmlin.html\">登录</a></li>\n" +
        "                <li><a href=\"/reg.html\">注册</a></li>\n" +
        "                <li><a href=\"/static/cart.html\">购物车</a></li>\n" +
        "            </ul>\n" +
        "        </div><!-- /.navbar-collapse -->\n" +
        "    </div><!-- /.container-fluid -->\n" +
        "</nav>";
...
function initCart() {
    // 如果用户没登录
    if (!loginFlag) {
        $("#cartDiv").html("<div style='text-align: center;'><h1>没有登录，请先<a href='/static/login.htmlin.html'>登录</a>或者<a href='reg.html'>注册</a></h1></div>");
    }
    // 如果用户登录了
    if (loginFlag) {
        $.ajax({
